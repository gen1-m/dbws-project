...
<body>
  <div class="container">
    ...
    <form method="post" action="../../../scripts/process_form.php">
      ...
      <label for="club_size">Club Size:</label>
      <input type="text" id="club_size" name="club_size" required>

      <label for="club_name">Club Name:</label>
      <input type="text" id="club_name" name="club_name" required>

      <label for="club_desc">Club Description:</label>
      <input type="text" id="club_desc" name="club_desc" required>
